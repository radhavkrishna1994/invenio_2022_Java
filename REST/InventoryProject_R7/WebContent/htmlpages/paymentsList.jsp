...
%>
 ...
 <%} %>
<%		java.util.List<com.bean.Invoice> paymentList = (java.util.List<com.bean.Invoice>) session					.getAttribute("paymentList");
	%>
											 ...
											 <ul class="art-vmenu">
												<li><a
													href="${pageContext.request.contextPath}/rest/inventory/getPayments">
																									<span
														class="t">See Today's Payments</span></a>
														</li>
									...
									<div class="art-post-inner art-article">
										...
										<table border="1">
											...
											<tr>
												...
												<% double totalDue=0; %>
											<%												for (com.bean.Invoice inv : paymentList) {
											%>
											...
											<tr>
												<tr>
													...
													<td><%= inv.getPoReference() %></td>
													<td><%= inv.getPaymentDueDate() %></td>
														<% totalDue+=inv.getInvAmount(); %>
										...
										<h3> Total Amount Due for Today: <%= totalDue%></h3>
										</div>
										<div class="cleared"></div>
									</div>
