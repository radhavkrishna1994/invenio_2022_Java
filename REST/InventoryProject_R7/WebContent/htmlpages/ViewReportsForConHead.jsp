	...
	<div id="art-main">
		<div class="art-sheet">
			...
			<div class="art-sheet-body">
				<div class="art-header">
					<div class="art-header-clip">
						<div class="art-header-center">
							<div class="art-header-jpeg" style="font-size: 20px;"><%= loginBean.getUsername() %> </div>
						</div>
					</div>
					<div class="art-logo">
				...
				<form name="f1"
					action="${pageContext.request.contextPath}/rest/inventory/getInvoiceDetailsPast" onsubmit="return validate()">
								...
								<div class="art-vmenublock">
									...
									<div class="art-vmenublock-body">
										<div class="art-vmenublockheader">
											<div class="l"></div>
											<div class="r"></div>
											<h3 class="t">SelectSite</h3>

										</div>
										<div class="art-vmenublockcontent">
											<div class="art-vmenublockcontent-body">
												<ul class="art-vmenu">
													<li><select class="art-vmenu" name="sitename">
															<c:forEach items="${siteListCh}" var="site">
										...
										<div class="art-vmenublockcontent">
											<div class="art-vmenublockcontent-body">
												<ul class="art-vmenu">
													...
													<li><a
														href="${pageContext.request.contextPath}/htmlpages/ConstructionHeadHome.jsp"><span
						...
						<div class="art-post-body">
							<div class="art-post-inner art-article">
								...
								<div class="art-postcontent">
									...
									<!-- <form
										action="http://localhost:8080/InventoryProject/rest/inventory/searchInvoiceMaterial">
										<input type="text" id="datepicker2" name="fromDate" /> <input
											type="text" id="datepicker3" name="toDate" /> <input
											type="text" name="itempattern" /> <input type="submit"
											value="search" />
									</form> -->
									<table>
										<tr>
										...
										<tr>
											...
											<%
												...
												%>
												<td><a href=" "><%=vendor.getTinNo()%></a></td>
												<td><%=vendor.getVendorName()%></td>
											<td><%= inv.getSiteName() %></td>
											<%-- <td>
												<% if(!(inv.getBillImagePath().equalsIgnoreCase("Not Uploaded"))) {%>
												<a
												href="http://localhost:8080/InventoryProject/rest/inventory/download?invoiceNo=<%=inv.getInvNo()%>">download</a>
												<%}else {%>
