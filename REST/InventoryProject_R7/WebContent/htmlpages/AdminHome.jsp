...
<body>
	...
	AdminHome ${pageContext.request.contextPath}
	<%
 ...
 --%>
												...
												<li><a
													href="${pageContext.request.contextPath}/rest/inventory/backup"><span
														class="active"></span><span class="t"></span><span
														class="t"> BackUp </span></a></li>
												<%-- <li><a
													href="${pageContext.request.contextPath}/rest/inventory/restore"><span
														class="active"></span><span class="t"></span><span
														class="t"> RestoreDatabase </span></a></li> --%>
												<li><a
									...
									<div class="art-post-inner art-article">
										...
										<div class="art-postcontent">
											...
											<img
												...
												alt="no image" width=600 height=400 />
