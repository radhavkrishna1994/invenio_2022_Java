								...
								<div class="art-post-body">
									<div class="art-post-inner art-article">
										...
										<div class="art-postcontent">
											<form name="myform"
												action="${pageContext.request.contextPath}/rest/inventory/createvendor"
												...
												<table style="border: thin;" align="center">
													...
													<tr>
														<td>Full Name</td>
														<td><input type="text" name="vendorName" /><span
															id="sp6"></span></td>
													...
													<tr>
														...
														<td><input type="text" name="vendorAddress" /><span
															id="sp7"></span></td>
													...
													<tr>
														<td>Phone No</td>
														<td><input type="text" name="vendorPhone" /><span id="sp8"></span></td>

													</tr>
													<tr>
														<td>Email Address</td>
														<td><input type="text" name="email" /><span id="sp8"></span></td>

													</tr>
													

													<tr>
														<td><input type="submit" value="StoreVendorDetails" /></td>
													</tr>
												</table>
											</form>
