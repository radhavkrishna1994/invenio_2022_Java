								...
								<div class="art-postcontent">
									...
									<table>
										...
										<tr>
											...
											<td><%=inv.getQuantity() %>&nbsp;<%=inv.getMaterial().getTerm()%>
											<%
											...
											<td>
												...
												%> <a
												href="${pageContext.request.contextPath}/rest/inventory/download?invoiceNo=<%=inv.getInvNo()%>">download</a>
												<%
													} else {
												%>
