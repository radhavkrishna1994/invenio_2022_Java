...
<%-- ${pageContext.request.contextPath}/rest/inventory/updateRequirementStatus?requirementId=<%=x.getRequirementNo()%> --%>
												...
												<tr>
													...
													<td> <% if(x.getStatus().equalsIgnoreCase("Request Sent")){ %> 
													
													<a href="${pageContext.request.contextPath}/htmlpages/POApproval.jsp?reqNo=<%= x.getRequirementNo()%>">ApproveToPO</a>
													 <%}
