						...
						<div class="art-post">
							<div class="art-post-body">
								<div class="art-post-inner art-article">
									...
									<p> Upload PO file for reference : <%= ((PO)session.getAttribute("selectedPO")).getPoReference() %></p>
										<form
												action="${pageContext.request.contextPath}/rest/inventory/uploadPo"
												method="post" enctype="multipart/form-data">
												
												<table>
														<tr>
														<th>Select PO File</th>
														<td><input type="file" name="file" size="45" /></td>

													</tr>

													<tr>
														<td><input type="submit" value="Upload PO" /></td>
													</tr>
												</table>
											</form>
									</div>
