		...
		<div class="art-sheet">
			...
			<div class="art-sheet-body">
				<div class="art-header">
					...
					<div class="art-logo">
						<img align="left"
							src="http://localhost:8080/InventoryProject/htmlpages/sriram_images/logo.jpg"
				...
				<form name="f1"
					action="http://localhost:8080/InventoryProject/rest/inventory/searchInvoiceMaterial" onsubmit="return validate()">
									...
									<div class="art-vmenublock-body">
										...
										<div class="art-vmenublockcontent">
											<div class="art-vmenublockcontent-body">
												<ul class="art-vmenu">
													<li><a
														href="http://localhost:8080/InventoryProject/htmlpages/AccountsManagerHome.jsp"><span
						...
						<div class="art-post-body">
							<div class="art-post-inner art-article">
								...
								<div class="art-postcontent">
									...
									<h3><a
										href="http://localhost:8080/InventoryProject/rest/inventory/downloadpdf">
										Click here to download : <c:out value="${fileName}" /> Report For <%= invoiceList.get(0).getMaterial().getDescription() %>
									</a>
									</h3>
									<br/>
									<table>
