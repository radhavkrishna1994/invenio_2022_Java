...
<link rel="stylesheet" href="${pageContext.request.contextPath}/htmlpages/style.css" type="text/css" media="screen" /> 
								...
								<div class="art-vmenublock-body">
									...
									<div class="art-vmenublockcontent">
										<div class="art-vmenublockcontent-body">
											 <ul class="art-vmenu">
												<li><a
													href="${pageContext.request.contextPath}/htmlpages/reports.jsp">
																									<span
														class="t">Get Invoice Details</span></a>
														</li>
													 <li><a
													href="${pageContext.request.contextPath}/rest/inventory/getMaterialList"><span
														class="t">Reports</span></a>
														</li>	 
														
														<li><a href="${pageContext.request.contextPath}/rest/inventory/logout"><span
							...
							<div class="art-post">
								<div class="art-post-body">
									<div class="art-post-inner art-article">
										...
										<img src="${pageContext.request.contextPath}/htmlpages/sriram_images/chirping_thumb.jpg" alt="no image" width=700 height=400/>
