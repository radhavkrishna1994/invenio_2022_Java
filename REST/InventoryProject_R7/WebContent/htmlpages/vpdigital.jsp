...
<tr><td><%= selectedPO.getOfficeAddress() %></td><td><%= selectedPO.getSiteAddress() %></td><td><%= selectedPO.getPoReference()%><%=selectedPO.getPoDate() %></td></tr>
...
<form action="${pageContext.request.contextPath}/rest/inventory/vpsign">
Add Your Digital Signature Here
<textarea rows="10" cols=80></textarea>
<input type="submit" value="DigitalSignatureFromCOO"/>
<input type="hidden" name="poReference" value=<%= selectedPO.getPoReference()%> />
</form>
<a
												href="${pageContext.request.contextPath}/htmlpages/VPHome.jsp">Home</a>
