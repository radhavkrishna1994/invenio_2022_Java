...
<li><a
												href="${pageContext.request.contextPath}/rest/inventory/getAllPOSignature">
													<span class="t">Pending PO</span>
											</a></li>
											<li><a
										...
										<table border="1" align="center">
											...
											%>
												...
												<tr>
													...
													<%-- <td> <% if(x.getStatus().equalsIgnoreCase("SentForFurthurApproval")){ %> 
													
													<a href="${pageContext.request.contextPath}/rest/inventory/updateRequirementStatus?requirementId=<%=x.getRequirementNo()%>">ApproveToPO</a>
													 <%}else if(x.getStatus().equalsIgnoreCase("Request Sent")){ %>
															Pending By Construction Head
													<%} else{%>
																	Approved
															<%} %>	
													</td> --%>
