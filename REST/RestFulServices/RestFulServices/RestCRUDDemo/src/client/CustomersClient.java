...
public class CustomersClient {
  public static void main(String[] args) {
    ...
    // Create one customer
    Customer customer = new Customer("3", "Blabla","old");
    ClientResponse response = service.path("rest").path("customers")
        .path(customer.getCustId()).accept(MediaType.APPLICATION_XML)
...
*/
  ...
  private static URI getBaseURI() {
    return UriBuilder.fromUri("http://localhost:8080/RestCRUDDemo").build();
  }
}